  ...
  implements ICommandListener
{
  ...
  public float knockbackReductionX;
  public float knockbackReductionY;
  public float knockbackReductionZ;
  ...
  public void b(Entity entity, int i)
  {
    ...
    Collection<ScoreboardScore> collection = this.world.getServer().getScoreboardManager().getScoreboardScores(IScoreboardCriteria.e, getName(), new ArrayList());
  ...
  public void attack(Entity entity)
  {
      ...
      (!entity.j(this)))
    {
      ...
      if ((f > 0.0F) || (f1 > 0.0F))
      {
        ...
        if ((flag) && (f > 0.0F)) {
          f *= this.world.paperSpigotConfig.criticalDamageMultiplier;
        }
        f += f1;
        boolean flag1 = false;
        ...
        if (flag2)
        {
          if (i > 0)
          {
            ...
            if ((isSprinting()) && (getBukkitEntity().getLastSprintKnockback() + 20L > now)) {
              i--;
            }
            getBukkitEntity().setLastSprintKnockback(now);
  ...
  {
    world.chunkProvider.getChunkAt(chunkcoordinates.x >> 4, chunkcoordinates.z >> 4);
